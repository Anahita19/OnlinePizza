...
{{--    <link rel="stylesheet" href="/admin/fonts-awesome/css/ionicons.min.css">--}}
{{--    <!-- Theme style -->--}}
                ...
                <ul class="nav navbar-nav">
                    ...
                    <li class="dropdown user user-menu">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                            ...
                            <span class="hidden-xs">Online Shop</span>
                        </a>
                        <ul class="dropdown-menu">
                            <!-- User image -->
        ...
        <section class="sidebar">
            ...
            <ul class="sidebar-menu">
                ...
                <li class="treeview">
                    ...
                    <ul class="treeview-menu">
                        <li><a href="{{route('products.index')}}"><i class="fa fa-circle-o"></i>products list</a></li>
                    </ul>
                </li>
